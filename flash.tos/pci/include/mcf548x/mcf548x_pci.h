...
#define MCF_PCI_PCIIDR                      (*(vuint32*)(&__MBAR[0x000B00]))
#define MCF_PCI_PCISCR                      (*(vuint32*)(&__MBAR[0x000B04]))
#define MCF_PCI_PCICCRIR                    (*(vuint32*)(&__MBAR[0x000B08]))
#define MCF_PCI_PCICR1                      (*(vuint32*)(&__MBAR[0x000B0C]))
#define MCF_PCI_PCIBAR0                     (*(vuint32*)(&__MBAR[0x000B10]))
#define MCF_PCI_PCIBAR1                     (*(vuint32*)(&__MBAR[0x000B14]))
#define MCF_PCI_PCISID                      (*(vuint32*)(&__MBAR[0x000B2C]))
#define MCF_PCI_PCICR2                      (*(vuint32*)(&__MBAR[0x000B3C]))
#define MCF_PCI_PCIGSCR                     (*(vuint32*)(&__MBAR[0x000B60]))
#define MCF_PCI_PCITBATR0                   (*(vuint32*)(&__MBAR[0x000B64]))
#define MCF_PCI_PCITBATR1                   (*(vuint32*)(&__MBAR[0x000B68]))
#define MCF_PCI_PCITCR                      (*(vuint32*)(&__MBAR[0x000B6C]))
#define MCF_PCI_PCIIW0BTAR                  (*(vuint32*)(&__MBAR[0x000B70]))
#define MCF_PCI_PCIIW1BTAR                  (*(vuint32*)(&__MBAR[0x000B74]))
#define MCF_PCI_PCIIW2BTAR                  (*(vuint32*)(&__MBAR[0x000B78]))
#define MCF_PCI_PCIIW3BTAR                  (*(vuint32*)(&__MBAR[0x000B7C]))
#define MCF_PCI_PCIIWBTAR(x)                (*(vuint32*)(&__MBAR[0x000B70+((x)*0x004)]))
#define MCF_PCI_PCIIW1BTAR                  (*(vuint32*)(&__MBAR[0x000B74]))
#define MCF_PCI_PCIIW2BTAR                  (*(vuint32*)(&__MBAR[0x000B78]))
#define MCF_PCI_PCIIWCR                     (*(vuint32*)(&__MBAR[0x000B80]))
#define MCF_PCI_PCIICR                      (*(vuint32*)(&__MBAR[0x000B84]))
#define MCF_PCI_PCIISR                      (*(vuint32*)(&__MBAR[0x000B88]))
#define MCF_PCI_PCICAR                      (*(vuint32*)(&__MBAR[0x000BF8]))
#define MCF_PCI_PCITPSR                     (*(vuint32*)(&__MBAR[0x008400]))
#define MCF_PCI_PCITSAR                     (*(vuint32*)(&__MBAR[0x008404]))
#define MCF_PCI_PCITTCR                     (*(vuint32*)(&__MBAR[0x008408]))
#define MCF_PCI_PCITER                      (*(vuint32*)(&__MBAR[0x00840C]))
#define MCF_PCI_PCITNAR                     (*(vuint32*)(&__MBAR[0x008410]))
#define MCF_PCI_PCITLWR                     (*(vuint32*)(&__MBAR[0x008414]))
#define MCF_PCI_PCITDCR                     (*(vuint32*)(&__MBAR[0x008418]))
#define MCF_PCI_PCITSR                      (*(vuint32*)(&__MBAR[0x00841C]))
#define MCF_PCI_PCITFDR                     (*(vuint32*)(&__MBAR[0x008440]))
#define MCF_PCI_PCITFSR                     (*(vuint32*)(&__MBAR[0x008444]))
#define MCF_PCI_PCITFCR                     (*(vuint32*)(&__MBAR[0x008448]))
#define MCF_PCI_PCITFAR                     (*(vuint32*)(&__MBAR[0x00844C]))
#define MCF_PCI_PCITFRPR                    (*(vuint32*)(&__MBAR[0x008450]))
#define MCF_PCI_PCITFWPR                    (*(vuint32*)(&__MBAR[0x008454]))
#define MCF_PCI_PCIRPSR                     (*(vuint32*)(&__MBAR[0x008480]))
#define MCF_PCI_PCIRSAR                     (*(vuint32*)(&__MBAR[0x008484]))
#define MCF_PCI_PCIRTCR                     (*(vuint32*)(&__MBAR[0x008488]))
#define MCF_PCI_PCIRER                      (*(vuint32*)(&__MBAR[0x00848C]))
#define MCF_PCI_PCIRNAR                     (*(vuint32*)(&__MBAR[0x008490]))
#define MCF_PCI_PCIRDCR                     (*(vuint32*)(&__MBAR[0x008498]))
#define MCF_PCI_PCIRSR                      (*(vuint32*)(&__MBAR[0x00849C]))
#define MCF_PCI_PCIRFDR                     (*(vuint32*)(&__MBAR[0x0084C0]))
#define MCF_PCI_PCIRFSR                     (*(vuint32*)(&__MBAR[0x0084C4]))
#define MCF_PCI_PCIRFCR                     (*(vuint32*)(&__MBAR[0x0084C8]))
#define MCF_PCI_PCIRFAR                     (*(vuint32*)(&__MBAR[0x0084CC]))
#define MCF_PCI_PCIRFRPR                    (*(vuint32*)(&__MBAR[0x0084D0]))
#define MCF_PCI_PCIRFWPR                    (*(vuint32*)(&__MBAR[0x0084D4]))
...
#define MCF_PCI_PCISID_VENDORID(x)          (((x)&0x0000FFFF)<<0)
...
/* Bit definitions and macros for MCF_PCI_PCITBATR */
#define MCF_PCI_PCITBATR_EN                 (0x00000001)
#define MCF_PCI_PCITBATR_BAT(x)             ((((x)&0xFFFC0000)))

/* Bit definitions and macros for MCF_PCI_PCITCR */
#define MCF_PCI_PCITCR_P                    (0x00010000)
#define MCF_PCI_PCITCR_LD                   (0x01000000)

/* Bit definitions and macros for MCF_PCI_PCIIWBTAR */
#define MCF_PCI_PCIIWBTAR_WBA(x)            ((((x)&0xFF000000)))
#define MCF_PCI_PCIIWBTAR_WAM(x)            ((((x)&0xFF000000)>>8))
#define MCF_PCI_PCIIWBTAR_WTA(x)            ((((x)&0xFF000000)>>16))
...
#define MCF_PCI_PCITNAR_NEXTADD(x)          (((x)&0xFFFFFFFF)<<0)
...
#define MCF_PCI_PCIRNAR_NEXTADD(x)          (((x)&0xFFFFFFFF)<<0)
