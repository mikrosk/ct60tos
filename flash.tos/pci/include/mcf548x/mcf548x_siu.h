...
#define MCF_SIU_SBCR              (*(vuint32*)(&__MBAR[0x000010]))
#define MCF_SIU_SECSACR           (*(vuint32*)(&__MBAR[0x000038]))
#define MCF_SIU_RSR               (*(vuint32*)(&__MBAR[0x000044]))
#define MCF_SIU_JTAGID            (*(vuint32*)(&__MBAR[0x000050]))
