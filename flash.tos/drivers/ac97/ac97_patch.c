...
{
	AC97_SINGLE(SNDRV_CTL_NAME_IEC958("", PLAYBACK, SWITCH), AC97_YMF7X3_DIT_CTRL, 0, 1, 0),
	{
		.iface	= SNDRV_CTL_ELEM_IFACE_MIXER,
...
//	if (ac97->pci && ac97->subsystem_vendor == 0x107b && ac97->subsystem_device == 0x0601)
//   	pregs = m675_regs;
...
{
	long subid = ((long)ac97->subsystem_vendor << 16) | ac97->subsystem_device;
	for (; *list; list++)
		if (*list == subid)
			return 1;
	return 0;
...
//	if (ac97->pci && ac97->subsystem_vendor == 0x1043 && ac97->subsystem_device == 0x1843) {
//		snd_ac97_write_cache(ac97, AC97_CM9739_SPDIF_CTRL,
//			snd_ac97_read(ac97, AC97_CM9739_SPDIF_CTRL) & ~0x01);
...
//	snd_ac97_rename_vol_ctl(ac97, "Master Playback", "Front Playback");
	...
	err = snd_ac97_add_vmaster(ac97, "Master Playback Switch", NULL, slave_sws_vt1616);
	if (err < 0)
		return err;
...
static int snd_ac97_vt1617a_smart51_put(struct snd_kcontrol *kcontrol,
					struct snd_ctl_elem_value *ucontrol)
{
	unsigned short usSM51, usMS, usReg;  
