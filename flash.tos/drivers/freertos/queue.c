...
signed portBASE_TYPE xQueueAltSend( xQueueHandle pxQueue, const void * const pvItemToQueue, portTickType xTicksToWait );
signed portBASE_TYPE xQueueAltReceive( xQueueHandle pxQueue, void * const pvBuffer, portTickType xTicksToWait );
...
xTimeOutType xTimeOut;
  ...
  if(pxQueue->magic != MAGIC_KEY)
    return(errQUEUE_HANDLE);
