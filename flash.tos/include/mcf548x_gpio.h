...
#define MCF_GPIO_PODR_FEC1L         (__MBAR+0x000A07)
...
#define MCF_GPIO_PDDR_FEC1L         (__MBAR+0x000A17)
#define MCF_GPIO_PDDR_FECI2C        (__MBAR+0x000A18)
...
#define MCF_GPIO_PPDSDR_FEC1L       (__MBAR+0x000A27)
...
#define MCF_GPIO_PAR_DMA            (__MBAR+0x000A43)
#define MCF_GPIO_PAR_FECI2CIRQ      (__MBAR+0x000A44)
#define MCF_GPIO_PAR_PCIBG          (__MBAR+0x000A48)
#define MCF_GPIO_PAR_PCIBR          (__MBAR+0x000A4A)
#define MCF_GPIO_PAR_PSC3           (__MBAR+0x000A4C)
#define MCF_GPIO_PAR_PSC2           (__MBAR+0x000A4D)
#define MCF_GPIO_PAR_PSC1           (__MBAR+0x000A4E)
#define MCF_GPIO_PAR_PSC0           (__MBAR+0x000A4F)
#define MCF_GPIO_PAR_DSPI           (__MBAR+0x000A50)
#define MCF_GPIO_PAR_TIMER          (__MBAR+0x000A52)
