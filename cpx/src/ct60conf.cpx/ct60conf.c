...
/* Didier MEQUIGNON - v0.98 - D‚cember 2002 */
...
char *rs_strings[] = {
	...
	"CT60 Configuration V0.98 D‚cembre 2002","","",
	"Ce CPX et systŠme:","","",
	"Didier MEQUIGNON","","",
...
char *rs_strings_en[] = {
	...
	"CT60 Configuration V0.98 December 2002","","",
	"This CPX and system:","","",
	"Didier MEQUIGNON","","",
	"didier-mequignon@wanadoo.fr","","",
	"System:","","",
...
struct bubblegem bubbletab[NB_BUB] = {
	...
	{MENUBMODE,
	"S‚lectionne au d‚marrage|le mode d'affichage|NTSC = 50 Hz, PAL = 60 Hz",
	"Select at boot|the display's mode|NTSC = 50 Hz, PAL = 60 Hz"},
	{MENUBCOUL,
