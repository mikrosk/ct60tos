...
#define BUS_ID_SIZE       20 /* KOBJ_NAME_LEN */
...
//	struct kset		devices;
	...
	int		(*suspend)(struct device * dev, unsigned long state);
...
//	struct module 		* owner;
	...
	int	(*suspend)	(struct device * dev, unsigned long state, unsigned long level);
	int	(*resume)	(struct device * dev, unsigned long level);
};
