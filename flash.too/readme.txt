...
port, look inside CT60.HYP for the schema. You must replace the 
SELECT/ signal pin 13 on the // port by the ACK/ signal pin 10. 
...
JTAG/parallel download cable notes:
-----------------------------------
