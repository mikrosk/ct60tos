...
#define MCF_I2C_I2AR          (*(vuint8 *)(&__MBAR[0x008F00]))
#define MCF_I2C_I2FDR         (*(vuint8 *)(&__MBAR[0x008F04]))
#define MCF_I2C_I2CR          (*(vuint8 *)(&__MBAR[0x008F08]))
#define MCF_I2C_I2SR          (*(vuint8 *)(&__MBAR[0x008F0C]))
#define MCF_I2C_I2DR          (*(vuint8 *)(&__MBAR[0x008F10]))
#define MCF_I2C_I2ICR         (*(vuint8 *)(&__MBAR[0x008F20]))
