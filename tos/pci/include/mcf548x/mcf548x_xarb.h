...
#define MCF_XARB_CFG             (*(vuint32*)(&__MBAR[0x000240]))
#define MCF_XARB_VER             (*(vuint32*)(&__MBAR[0x000244]))
#define MCF_XARB_SR              (*(vuint32*)(&__MBAR[0x000248]))
#define MCF_XARB_IMR             (*(vuint32*)(&__MBAR[0x00024C]))
#define MCF_XARB_ADRCAP          (*(vuint32*)(&__MBAR[0x000250]))
#define MCF_XARB_SIGCAP          (*(vuint32*)(&__MBAR[0x000254]))
#define MCF_XARB_ADRTO           (*(vuint32*)(&__MBAR[0x000258]))
#define MCF_XARB_DATTO           (*(vuint32*)(&__MBAR[0x00025C]))
#define MCF_XARB_BUSTO           (*(vuint32*)(&__MBAR[0x000260]))
#define MCF_XARB_PRIEN           (*(vuint32*)(&__MBAR[0x000264]))
#define MCF_XARB_PRI             (*(vuint32*)(&__MBAR[0x000268]))
